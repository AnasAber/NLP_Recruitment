...
def get_resume_details(resume_text: str = None):
    ...
    try:
        if resume_text:
            ...
            print(
                f"this is the response of the resume details to json:\
            {response_json}"
            )
    ...
    try:
        if job_site_content:
            ...
            if job_details:
                ...
                print(
                    f"this is the response of the job details to json:\
                {job_details}"
                )
                return job_details
            else:
    ...
    try:
        ...
        for section in [
            ...
            prompt = PromptTemplate(
                ...
                section_data=json.dumps(user_data[section]), job_description=json.dumps(job_details)
            )
