...
from prompts.resume_prompts import RESUME_DETAILS_EXTRACTOR, JOB_DETAILS_EXTRACTOR, TEXT_GENERATING_TEMPLATE
import PyPDF2
import re
...
def resume_to_json(self, resume_text):
        ...
        print(f"this is the response of the resume to json:\
              {response_json}")
